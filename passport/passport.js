...
passport.use('register', new Strategy({ usernameField: 'email', passwordField: 'password', passReqToCallback: true}, 
...
passport.use('login', new Strategy({ usernameField: 'email', passwordField: 'password'
